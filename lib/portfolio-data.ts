  ...
  cyberini: [
    {
      ...
      image: "/cyberini-cert-1.png",
    },
    {
      id: 2,
      title: "MOOC Cybersécurité de Cyberini",
      image: "/cyberini-cert-2.png",
    },
  ],
  splunk: [
    { id: 1, title: "Intro to Splunk (eLearning)", image: "/splunk-cert-1.png" },
    { id: 2, title: "Introduction to Dashboards (eLearning)", image: "/splunk-cert-2.png" },
    { id: 3, title: "Search Under the Hood (eLearning)", image: "/splunk-cert-3.png" },
    { id: 4, title: "Using Fields (eLearning)", image: "/splunk-cert-4.png" },
    { id: 5, title: "Visualizations (eLearning)", image: "/splunk-cert-5.png" },
    { id: 6, title: "Introduction to Enterprise Security (eLearning)", image: "/splunk-cert-6.png" },
    { id: 7, title: "ES 8.0 Updates for the Splunk SOC (eLearning)", image: "/splunk-cert-7.png" },
    { id: 8, title: "The Cybersecurity Landscape (eLearning)", image: "/splunk-cert-8.png" },
    { id: 9, title: "Understanding Threats and Attacks (eLearning)", image: "/splunk-cert-9.png" },
    { id: 10, title: "Security Operations and the Defense Analyst (eLearning)", image: "/splunk-cert-10.png" },
    { id: 11, title: "Data and Tools for Defense Analysts (eLearning)", image: "/splunk-cert-11.png" },
    { id: 12, title: "The Art of Investigation (eLearning)", image: "/splunk-cert-12.png" },
    { id: 13, title: "SOC Essentials: Investigating with Splunk (free eLearning)", image: "/splunk-cert-13.png" },
    { id: 14, title: "Introduction to Detection Engineering with Splunk", image: "/splunk-cert-14.png" },
  ],
  cisco: [
    {
      id: 1,
